...
CMDLINE="console=ttyHSL0,115200,n8 androidboot.hardware=bacon user_debug=31 msm_rtb.filter=0x3F ehci-hcd.park=3 androidboot.bootdevice=msm_sdcc.1"
BASE="0x00000000"
PAGESIZE="2048"
...
# Paths
KERNEL_DIR="${HOME}/android/source/kernel/msm8974_OPO-CAF_render_kernel"
OZIP_DIR="${HOME}/android/source/kernel/msm8974_OPO-CAF_render_kernel/ozip"
MODULES_DIR="${HOME}/android/source/kernel/msm8974_OPO-CAF_render_kernel/ozip/system/lib/modules"
RAMDISK_DIR="${HOME}/android/source/kernel/msm8974_OPO_render_kernel_ramdisk"
ZIP_MOVE="${HOME}/android/source/zips/opo-caf-zips"
ZIMAGE_DIR="${HOME}/android/source/kernel/msm8974_OPO-CAF_render_kernel/arch/arm/boot"
TOOLS_DIR="${HOME}/android/source/render-tools"
OUT_DIR="${HOME}/android/source/out/opo-caf"
RAMDISK="$OUT_DIR/ramdisk.gz"
VARIANT="OPO-CAF"

# Functions
function clean_all {
		rm -rf /home/renderbroken/android/source/kernel/msm8974_OPO-CAF_render_kernel/ozip/system/lib/modules/*
